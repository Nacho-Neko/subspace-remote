...
use subspace_farmer::farmer_piece_remote_getter::RemotePieceGetter;
    ...
    PosTable: Table,
{
    ...
    let node_client = RemoteNodeClient::new(nats_client.clone());
    ...
    let piece_getter = RemotePieceGetter::new(
        nats_client.clone(),
        piece_provider,
        farmer_cache.clone(),
        node_client.clone(),
